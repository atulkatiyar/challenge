...
class AccountsControllerTest {
  ...
  void transferAmount() throws Exception {
    ...
    this.mockMvc.perform(post("/v1/accounts/transfer").contentType(MediaType.APPLICATION_JSON)
            .content("{\"fromAccountId\":\"Id-123\",\"toAccountId\":\"Id-456\",\"amount\":1000}")).andExpect(status().is2xxSuccessful());
  ...
  @Test
  void transferAmountWithNotEnoughBalance() throws Exception {
    this.mockMvc.perform(post("/v1/accounts").contentType(MediaType.APPLICATION_JSON)
    ...
    this.mockMvc.perform(post("/v1/accounts/transfer").contentType(MediaType.APPLICATION_JSON)
            .content("{\"fromAccountId\":\"Id-123\",\"toAccountId\":\"Id-456\",\"amount\":1000}")).andExpect(status().isBadRequest());
  }

  @Test
  void transferAmountWithInvalidAMount() throws Exception {
    this.mockMvc.perform(post("/v1/accounts").contentType(MediaType.APPLICATION_JSON)
            .content("{\"accountId\":\"Id-123\",\"balance\":0}")).andExpect(status().isCreated());
